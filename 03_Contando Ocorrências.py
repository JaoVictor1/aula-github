...
print("Quantas vezes o número 2 aparece?", contar_ocorrencias(numeros, 13))
print("Quantas vezes o número 13 aparece?", contar_ocorrencias(numeros, 42))
print("Quantas vezes o número 999 aparece?", contar_ocorrencias(numeros, 9))